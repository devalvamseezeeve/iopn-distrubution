module github.com/devalvamseezeeve/iopn-distrubution/versiondb
...
require (
	...
	github.com/devalvamseezeeve/iopn-distrubution/memiavl v0.0.3
...
replace github.com/devalvamseezeeve/iopn-distrubution/memiavl => ../memiavl
