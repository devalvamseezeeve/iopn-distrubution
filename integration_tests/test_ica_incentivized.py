...
def test_incentivized(ibc):
    ...
    cli_controller = ibc.iopn.cosmos_cli()
    ...
    ibc.iopn.supervisorctl("stop", "relayer-demo")
    time.sleep(3)
    port_id = "icahost"
    ...
    ibc.iopn.supervisorctl("start", "relayer-demo")
    ...
    actual = get_balance(ibc.iopn, sender, fee_denom)
