...
Cronos#429 (https://github.com/devalvamseezeeve/iopn-distrubution/pull/429) bumps ibc-go dependency to v3.0.0 which include ICS30 middleware support.

Cronos#511(https://github.com/devalvamseezeeve/iopn-distrubution/pull/511) replaces the "hook" with a custom ICS30 middleware.
