...
type Params struct {
	...
	CronosAdmin          string `protobuf:"bytes,3,opt,name=iopn_admin,json=iopnAdmin,proto3" json:"iopn_admin,omitempty"`
...
func init() {
	proto.RegisterType((*Params)(nil), "iopn.Params")
	proto.RegisterType((*TokenMappingChangeProposal)(nil), "iopn.TokenMappingChangeProposal")
	proto.RegisterType((*TokenMapping)(nil), "iopn.TokenMapping")
}

func init() { proto.RegisterFile("iopn/iopn.proto", fileDescriptor_8bc54992a93db2d2) }
