...
import (
	...
	ica "github.com/devalvamseezeeve/iopn-distrubution/v2/x/iopn/events/bindings/cosmos/precompile/ica"
	relayer "github.com/devalvamseezeeve/iopn-distrubution/v2/x/iopn/events/bindings/cosmos/precompile/relayer"
...
var (
	...
	IcaValueDecoders = ValueDecoders{
		iopneventstypes.AttributeKeySeq:   ConvertUint64,
		channeltypes.AttributeKeySrcChannel: ReturnStringAsIs,
	}
)
